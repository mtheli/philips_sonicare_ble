...
| **Pairing** | Model-dependent: DiamondClean Smart (HX992X) and Sonicare For Kids (HX6340) use open GATT; ExpertClean (HX962V), HX991M, and DiamondClean Prestige (HX999X) require BLE bonding |
